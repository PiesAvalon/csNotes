...
0000000000400620 <deregister_tm_clones>:
  400620:	b8 87 11 60 00       	mov    $0x601187,%eax
  400625:	55                   	push   %rbp
  400626:	48 2d 80 11 60 00    	sub    $0x601180,%rax
  ...
  400641:	5d                   	pop    %rbp
  400642:	bf 80 11 60 00       	mov    $0x601180,%edi
  400647:	ff e0                	jmp    *%rax
  400649:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

0000000000400650 <register_tm_clones>:
  400650:	b8 80 11 60 00       	mov    $0x601180,%eax
  400655:	55                   	push   %rbp
  400656:	48 2d 80 11 60 00    	sub    $0x601180,%rax
  ...
  400682:	bf 80 11 60 00       	mov    $0x601180,%edi
  400687:	ff e2                	jmp    *%rdx
  400689:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

0000000000400690 <__do_global_dtors_aux>:
  400690:	80 3d f1 0a 20 00 00 	cmpb   $0x0,0x200af1(%rip)        # 601188 <completed.6355>
  ...
  4006a2:	5d                   	pop    %rbp
  4006a3:	c6 05 de 0a 20 00 01 	movb   $0x1,0x200ade(%rip)        # 601188 <completed.6355>
...
0000000000400721 <main>:
  ...
  40073e:	48 8b 05 3b 0a 20 00 	mov    0x200a3b(%rip),%rax        # 601180 <stdin@GLIBC_2.2.5>
  ...
  4007dc:	bf a0 11 60 00       	mov    $0x6011a0,%edi
  ...
  4007f2:	bf a0 11 60 00       	mov    $0x6011a0,%edi
  ...
  40081a:	bf a0 11 60 00       	mov    $0x6011a0,%edi
  40081f:	e8 b9 fe ff ff       	call   4006dd <fixinput>
  400824:	bf a0 11 60 00       	mov    $0x6011a0,%edi
  400829:	e8 5d 00 00 00       	call   40088b <phase>
...
000000000040086d <__func_gSrkiqAw>:
  40086d:	55                   	push   %rbp
...
000000000040088b <phase>:
  40088b:	55                   	push   %rbp
  40088c:	48 89 e5             	mov    %rsp,%rbp
  40088f:	48 89 7d d8          	mov    %rdi,-0x28(%rbp)
  400893:	c7 45 fc b1 fe 3c 54 	movl   $0x543cfeb1,-0x4(%rbp)
  40089a:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
  4008a1:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
  4008a5:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
  4008a9:	e9 95 00 00 00       	jmp    400943 <phase+0xb8>

  4008ae:	48 8b 45 f0          	mov    -0x10(%rbp),%rax # p1 + i
  4008b2:	0f b6 00             	movzbl (%rax),%eax
  4008b5:	0f be c0             	movsbl %al,%eax
  4008b8:	83 e8 41             	sub    $0x41,%eax 
  4008bb:	83 f8 06             	cmp    $0x6,%eax
  4008be:	77 7e                	ja     40093e <phase+0xb3>
  4008c0:	89 c0                	mov    %eax,%eax
  4008c2:	48 8b 04 c5 50 0b 40 	mov    0x400b50(,%rax,8),%rax # 4008cc  4008d2 4008d8 4008de 4008e4 4008ea 400917
  4008c9:	00 
  4008ca:	ff e0                	jmp    *%rax # swich(p1[i]):
 # rax = 0 case 47:
  4008cc:	c1 4d fc 1c          	rorl   $0x1c,-0x4(%rbp)
  4008d0:	eb 6c                	jmp    40093e <phase+0xb3>
# rax = 1 case 48:
  4008d2:	c1 4d fc 04          	rorl   $0x4,-0x4(%rbp)
  4008d6:	eb 66                	jmp    40093e <phase+0xb3>
# rax = 2 case 49:
  4008d8:	c1 4d fc 18          	rorl   $0x18,-0x4(%rbp)
  4008dc:	eb 60                	jmp    40093e <phase+0xb3>
# rax = 3 case 50:
  4008de:	c1 4d fc 08          	rorl   $0x8,-0x4(%rbp)
  4008e2:	eb 5a                	jmp    40093e <phase+0xb3>
# rax = 4 case 51:
  4008e4:	c1 4d fc 10          	rorl   $0x10,-0x4(%rbp)
  4008e8:	eb 54                	jmp    40093e <phase+0xb3>
# rax = 5 case 52:     交换高4位和次高4位
  4008ea:	8b 45 fc             	mov    -0x4(%rbp),%eax
  4008ed:	25 00 00 00 f0       	and    $0xf0000000,%eax
  4008f2:	c1 e8 04             	shr    $0x4,%eax
  4008f5:	89 c2                	mov    %eax,%edx
  4008f7:	8b 45 fc             	mov    -0x4(%rbp),%eax
  4008fa:	25 00 00 00 0f       	and    $0xf000000,%eax
  4008ff:	c1 e0 04             	shl    $0x4,%eax
  400902:	09 d0                	or     %edx,%eax
  400904:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400907:	8b 45 fc             	mov    -0x4(%rbp),%eax
  40090a:	25 ff ff ff 00       	and    $0xffffff,%eax
  40090f:	0b 45 ec             	or     -0x14(%rbp),%eax
  400912:	89 45 fc             	mov    %eax,-0x4(%rbp)
  400915:	eb 27                	jmp    40093e <phase+0xb3>
# rax = 6 case 53:     交换高4位和次高4位
  400917:	8b 45 fc             	mov    -0x4(%rbp),%eax
  40091a:	25 f0 00 00 00       	and    $0xf0,%eax
  40091f:	c1 e8 04             	shr    $0x4,%eax
  400922:	89 c2                	mov    %eax,%edx
  400924:	8b 45 fc             	mov    -0x4(%rbp),%eax
  400927:	c1 e0 04             	shl    $0x4,%eax
  40092a:	0f b6 c0             	movzbl %al,%eax
  40092d:	09 d0                	or     %edx,%eax
  40092f:	89 45 ec             	mov    %eax,-0x14(%rbp)
  400932:	8b 45 fc             	mov    -0x4(%rbp),%eax
  400935:	b0 00                	mov    $0x0,%al
  400937:	0b 45 ec             	or     -0x14(%rbp),%eax
  40093a:	89 45 fc             	mov    %eax,-0x4(%rbp)
  40093d:	90                   	nop

  40093e:	48 83 45 f0 01       	addq   $0x1,-0x10(%rbp) # i++

  400943:	48 8b 45 f0          	mov    -0x10(%rbp),%rax # p1 + i
  400947:	0f b6 00             	movzbl (%rax),%eax # p1[i]
  40094a:	84 c0                	test   %al,%al
  40094c:	0f 85 5c ff ff ff    	jne    4008ae <phase+0x23>        # if p1[i] != 0, back
  400952:	81 7d fc f1 c4 b3 e5 	cmpl   $0xe5b3c4f1,-0x4(%rbp)    # if -0x4(%rbp) == 0xe5b3c4f1, success
  400959:	0f 94 c0             	sete   %al
  40095c:	0f b6 c0             	movzbl %al,%eax
  40095f:	5d                   	pop    %rbp
  400960:	c3                   	ret
  400961:	66 2e 0f 1f 84 00 00 	cs nopw 0x0(%rax,%rax,1)
  400968:	00 00 00 

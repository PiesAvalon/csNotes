...
static void instr_execute_2op() 
{
    ...
    opr_dest.val = sign_ext(alu_sub(opr_src.val, opr_dest.val, opr_dest.data_size), opr_dest.data_size);
...
make_instr_impl_2op(sub, a, o, b)
make_instr_impl_2op(sub, a, o, v)
make_instr_impl_2op(sub, o, a, b)
make_instr_impl_2op(sub, o, a, v)
